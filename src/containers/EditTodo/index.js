...
class EditTodo extends React.Component {
    ...
    componentDidMount() {
        ...
        this.setState({id: this.props.todoItem.id})
    ...
    render() {
        return (
            <div id="edit_todo" className="container">
                <div className="inner_window_header row justify-content-center">
                    <p>Редактирование задачи</p>
                </div>
                <div className="edit_todo_priority row form-group ">
                    <label htmlFor="priority_select" className="">Приоритет:</label>
                    <select onChange={this.changePriority} className="form-control form-control-sm" name="priority_select" id="" defaultValue={this.props.todoItem.priority}>
                        <option value="low">Низкий</option>
                        <option value="normal">Обычный</option>
                        <option value="high">Высокий</option>
                    </select>
                </div>
                <div className="edit_todo_content row justify-content-center">
                    <textarea maxLength="256" minLength="5" name="todo_content" defaultValue={this.props.todoItem.content} onKeyDown={this.preventOverrange}  onChange={this.changeContent}  />
                </div>
                ...
                <div className="inner_window_footer row justify-content-center" >
                    ...
                    <button className="btn btn-save cancel_modal" onClick={this.handleEditTodo}>Сохранить</button>
                </div>
            </div>
        );
    }
